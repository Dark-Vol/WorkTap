...
import "./style.css";
import KworkImage from "../public/icon/kworks_create.svg";
    ...
    <div className="container">
      ...
      <div className="mt-7 grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3">
        <div className="w-[100%] flex flex-col items-center justify-center">
          <button className="bg-green-500 w-[50px] h-[50px] text-white text-[25px] rounded-3xl">
            +
          </button>
        ...
        <div className="w-[100%] flex flex-col justify-between relative hover:shadow-lg overflow-hidden">
          ...
          <div className="p-2">
            ...
            <h3 className="text-green-500 font-bold mt-3 md:text-[18px]">
              50 000 UAH
            </h3>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center mt-12">
        <button className="w-[200px] h-[40px] rounded-full border-[1px] border-[#1DBF73] transition-all text-[#1DBF73] hover:bg-[#1DBF73] hover:text-white">
          Загрузить еще
        </button>
      </div>
    </div>
